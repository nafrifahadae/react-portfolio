  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src="./img/logo-v3.png" alt="NAA logo" height={40} width={80} />
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/nathaniel-afrifah-adae/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Nathaniel Afrifah-Adae, 2024</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
